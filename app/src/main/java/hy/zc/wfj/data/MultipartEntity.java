 ...
 * copy from http://blog.csdn.net/bboyfeiyu/article/details/42266869
 */
public class MultipartEntity implements HttpEntity {
     ...
     * Content-Disposition: form-data; name="key"; filename="pfilename"
     * Content-Transfer-Encoding: binary
     *
     * xianzainikandaodezheyihangshizhuanhuantupiandebytezijiema
     *
     * @param key
     *          就是上面例子中的name里面的值
     * @param pfilename
     *          就是上面例子中的filename里面的值
     * @param rawData
     *          就是上面例子中的转换为二进制文件转换成的字节码
     */
    public void addBinaryPart(String key,String pfilename, final byte[] rawData) {
//        writeToOutputStream(paramName, rawData, TYPE_OCTET_STREAM, BINARY_ENCODING, "no-file");
        writeToOutputStream(key, rawData, TYPE_OCTET_STREAM, BINARY_ENCODING, pfilename);
    }
